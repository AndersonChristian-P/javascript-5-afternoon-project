...
Movie.prototype.changeRating = function (new_rating) {
  let rating = (+this.rating + +new_rating) / 2
...
User.prototype.addSavedPost = function (id, title, rating) {
  ...
  return this.savedPosts = [...this.savedPosts, savedPost]
}
...
// Code here
User.prototype.removeSavedPost = function (post_id) {
  let index = this.savedPosts.indexOf(+this.savedPosts.id === +post_id)
...
User.prototype.changePostRating = function (id, new_rating) {
